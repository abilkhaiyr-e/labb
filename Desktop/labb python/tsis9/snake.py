...
apple = pygame.image.load("C:/Users/user/Desktop/labb python/tsis9/files/apple.png").convert_alpha()#getting apple image
golden = pygame.image.load("C:/Users/user/Desktop/labb python/tsis9/files/goldapple.png").convert_alpha()
